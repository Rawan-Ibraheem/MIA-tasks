...
class Verstappen(Driver):
    def __init__(self):
        offensive = [ # list of objects
            OffensiveMove("DRS Boost", 45, 12), # name , fuel , damage
    ...
    def run(self):
        ...
        while self.driver1.is_alive() and self.driver2.is_alive():
            ...
            if not self.driver1.has_usable_move() and not self.driver2.has_usable_move():
                print("\n Both drivers are out of usable moves. The race ends in a tie!")
                return
            ...
            # Defender randomly chooses defense or counterattack
            ...
            if not counter_move:
                ...
                attacker.apply_damage(counter_move.tire_damage) # attacker is damaged too from the defender
                actual_damage = attack_move.tire_damage # for defender
